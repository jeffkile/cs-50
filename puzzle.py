...
knowledge0 = And(
    ...
    Implication(And(AKnight, AKnave), AKnight), # If the implication is true they are a knight
    Implication(Not(And(AKnight, AKnave)), AKnave) # If this implication is false they are a knave
)
